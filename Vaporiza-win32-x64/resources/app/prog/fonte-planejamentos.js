...
function gerar_apresentacao(planejamento, lista) {
    ...
    lista.push({
        tipo: "paragrafo",
        cont: "Este é o relatório de planejamento gerado pelo Vaporiza. Informações como quantidade de produtos, consumo de vapor e matérias utilizadas podem ser encontradas aqui. Abaixo, algumas informações principais sobre a produção cadastrada."
    });
    lista.push({
        tipo: "tabela",
        legenda: false,
...
function gerar_producao(planejamento, lista) {
    ...
    lista.push({
        tipo: 'paragrafo',
        cont: `Para melhor visualização da produção cadastrada (${nome}), veja logo abaixo uma tabela demonstrativa com os dados que você cadastrou. Cada linha corresponde a um dia de produção, exceto os dias marcados como não operacionais (feriados), junto com os produtos a serem produzidos e a estimativa de vapor gasto para concretizar tota a operação.`
    });
    lista.push({
        tipo: 'tabela',
        legenda: true,
...
function gerar_descricao_materias(planejamento, lista) {
    ...
    /*lista.push({
        tipo: 'paragrafo',
        cont: 'Na seguinte tabela estão listadas todas as matérias que serão utilizadas para realizar todas as produções do período informado, assim como a quantidade total que será gasta. Em outras palavras, para produzir os produtos informados, as matérias-prima necessárias estão na tabela abaixo. A frequência de uso é a quantidade de vezes que uma mesma matéria foi utilizada para produzir diversos produtos, o que significa que quanto maior este valor, mais produtos dependem desta matéria para serem produzidos.'
    });*/
    lista.push({
        tipo: 'tabela',
        legenda: true,
...
function gerar_descricao_produtos(planejamento, lista) {
    ...
    const rotulos = ['Produto', 'Consumo de Vapor (kg)', 'Porcentagem de Consumo'];
    const linhas = [];
    ...
    /*lista.push({
        tipo: 'paragrafo',
        cont: 'A próxima tabela contêm informações relativas aos produtos que serão produzidos no planejamento cadastrado. Cada linha informa o vapor total gasto na produção (soma de todos os dias) e a porcentagem de consumo. Este dado informa qual produto consumirá maior quantidade de vapor.'
    });*/
    lista.push({
        tipo: 'tabela',
        legenda: true,
...
function gerar_tabela_vapor_combustivel(planejamento, lista) {
    ...
    /*lista.push({
        tipo: 'paragrafo',
        cont: 'Na tabela abaixo, estão relacionadas as quantidades de vapor e combustível consumidos em cada dia da produção. A última tabela é uma relação entre vapor e combustível.'
    });*/
    lista.push({
        tipo: 'tabela',
        legenda: true,
...
function gerar_grafico_consumo_diario(planejamento, lista) {
    ...
    lista.push({
        tipo: 'paragrafo',
        cont: 'O gŕafico abaixo faz a realção entre o vapor consumido (eixo da esquerda) e o combustível gasto (eixo da direita), para cada dia de produção.'
    });
    lista.push({
        tipo: 'grafico',
        valoresX: eixoX,
...
function gerar_grafico_consumo_por_produto(planejamento, lista) {
    ...
    lista.push({
        tipo: 'paragrafo',
        cont: 'O gŕafico abaixo faz a realção entre o vapor consumido (eixo da esquerda) e o combustível gasto (eixo da direita), para cada produto cadastrado neste planejamento.'
    });
    lista.push({
        tipo: 'grafico',
        valoresX: eixoX,
